...
class _EditMyAccountState extends State<EditMyAccount> {
  ...
  final UpdateUserProfilPhoto _updateUserProfilPhoto = new UpdateUserProfilPhoto();
  File _userNewPhoto;
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  _userNewPhoto == null ? _getUserPhotoService.getUserProfilePhoto(user): Image.file(_userNewPhoto),
                  Row(
                    children: <Widget>[
                      RaisedButton(
                        color: Colors.cyan,
                    ...
                    onPressed: () async {
                      try {
                        ...
                        if (_userNewPhoto != null)
                          await _updateUserProfilPhoto.updateProfilPhoto(user, _userNewPhoto);
  ...
  _imagePicker(ImageSource source) async {
    File selector = await ImagePicker.pickImage(source: source);
    setState(() {
      _userNewPhoto = selector;
    });
  }
}
